...
while {true} do
{
	...
	_strArray pushBack format ["%1 <img size='0.7' image='client\icons\bounty.paa'/>", [player getVariable ["cbounty", 0]] call fn_numbersText]; //Cael817, SNAFU, Add bounty icon and value
	...
	{
		_tempString = format ["<t color='#A0FFFFFF'>SNAFU A3Wasteland %1<br/>www.a3wasteland.com</t>", getText (configFile >> "CfgWorlds" >> worldName >> "description")];
		_yOffset = 0.40; //Cael817, SNAFU, Raise Stream Friendly text over icons
	...
	else
	{
		...
		{
			_yOffset = 0.32; //Cael817, SNAFU, Raise driver and gunner icons so they don't overlap bounty and ATM icons
