//	@file Version: 1.0
//	@file Name: sellVehicleContents.sqf
//	@file Author: Munch for TeamBio
//	@file Created: 3/1/2014
//	@file Args:

// The purpose of this script to sell the contents of a vehicle to a store owner
// Called only from actionHandler defined in TB_fnc_setVehSell

#define PRICE_DEBUGGING true

private ["_thisPlayer","_thisVehicle"];

// Make sure this script isn't already running ... exit if it is
...
// get the vehicle
_thisVehicle = _this select 3 select 0;

storeSellingHandle = _thisVehicle spawn
{
