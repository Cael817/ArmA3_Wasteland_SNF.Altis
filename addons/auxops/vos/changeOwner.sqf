...
*/		
			...
			_text = format ["Changing owner for %1 for $%2. Removing VIN, oh, you got fuel need to remove that.", _type, _price];
			...
			_vehicle setVariable ["extraDriverUID", nil, true]; 
			...
			playSound "FD_Finish_F";
			_text = format ["%1 Is now yours to lock and it saves to. Fully repaired and refuelled", _type];
