...
//@file Author: Cael817, Soundpathing by LouDnl
//@file Info: Chance of toolkit breaking and time to break in is based of vehicle price, if your vehicle is ~400k you may need to adjust for that, otherwice the chance is 100% toolkit breakage

/*
AUXOPS_Break_Vehicle_Lock =
{
	Hint "Break Lock";
}
call mf_compile;
...
if (_break < _price / 4) exitWith {
 ...
 for "_i" from _price to 0 step -1 do
 {
	...
	_soundToPlay = _soundPath + "addons\AUXOPS\sounds\carhorn.ogg";
	...
	_soundPath = [(str missionConfigFile), 0, -15] call BIS_fnc_trimString;
	_soundToPlay = _soundPath + "addons\AUXOPS\sounds\carlock.ogg";
