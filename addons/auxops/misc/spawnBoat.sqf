//Not used right now, just saving the code
	...
	// H key, //Cael817, possibly add temporary rubberboat, from Munch
	case (_key == 35):
    {
		...
		if(_legit == 1) then {
			...
			_vehicle = createVehicle ["C_Rubberboat",_pos, [], 0, "CAN_COLLIDE"];
			...
			_text = "You have spawned a temporary boat which will exist for 10 minutes. Use the time wisely";
        } else {
