...
class AF_Key1: KP_RscButton
{
	...
	Action = "[""number"", 1]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key2: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 2]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key3: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 3]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key4: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 4]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key5: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 5]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key6: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 6]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key7: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 7]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key8: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 8]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key9: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 9]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key_Clear: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""clear"", 0]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key0: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 0]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
class AF_Key_Enter: KP_RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""enter"", 0]execVM ""addons\AUXOPS\AF_Keypad\AF_KP_fncs.sqf""";
};
