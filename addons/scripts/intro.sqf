//@file Version: ?
//@file Name: intro.sqf
//@file Author: loudNL? atleast i "found" it in his mission ;-)
...
_messages = [
	["SNAFU", "SNAFU A3Wasteland"],
	["Welcome", (name player)],
	["A3Wasteland", worldName],
	["Teamspeak", "176.10.245.30"],
	["Website/Forums", "TBD"],
	["Saving", "Everything autosaves every minute or so"],
	["ATM / Bank", "You can save some of your money at the ATMs, needed for airdrop"],
