...
ElevatedMissionMarkers =[]; //Cael817, Changed from "SniperMissionMarkers"
{
	switch (true) do
	{
		...
		case (["RoadBlockMission_", _x] call fn_startsWith): //Cael817, Changed from "RoadBlock_"
		{
			RoadblockMissionMarkers pushBack [_x, false];
		};
		case (["ElevatedMission_", _x] call fn_startsWith): //Cael817, Changed from "Sniper_"
		{
			ElevatedMissionMarkers pushBack [_x, false]; //Cael817, Changed from "SniperMissionMarkers"
		};
	};
